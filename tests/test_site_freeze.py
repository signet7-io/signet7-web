...
class SiteFreeze20260822Tests(unittest.TestCase):
    ...
    def test_door_keeps_people_behind_type(self) -> None:
        ...
        self.assertIn("assets/blueprint/homepage.jpg?v=20260916a", self.home)
    ...
    def test_loop_on_every_page_under_the_hero(self) -> None:
        ...
        for path in root_html_pages():
            ...
            with self.subTest(page=path.name):
                self.assertIn("assets/site.css?v=20260916a", html)
    ...
    def test_homepage_mute_study_films(self) -> None:
        ...
        self.assertIn('id="play"', self.home)
        self.assertIn("assets/blueprint/check.jpg?v=20260916a", self.home)
        self.assertIn("assets/blueprint/evidence.jpg?v=20260916a", self.home)
        self.assertIn("assets/blueprint/howto.jpg?v=20260916a", self.home)
